...
const techStacks = [
  ...
  { icon: "svelte.svg", language: "Svelte" },
  ...
  { icon: "babel.svg", language: "Babel" },
  { icon: "redux.svg", language: "Redux" },
  { icon: "graphql.svg", language: "GraphQL" },

  // Testing
  { icon: "jest.svg", language: "Jest" },
  { icon: "cypress.svg", language: "Cypress" },
  { icon: "selenium.svg", language: "Selenium" },

  // Other
  { icon: "sweetalert2.svg", language: "SweetAlert2" },
];

const certificateImages = [
  "/dist/assets/aws1.png",
  "/dist/assets/aws2.png",
  "/dist/assets/aws3.png",
  "/dist/assets/aws4.png",
  "/dist/assets/py1.png",
  "/dist/assets/py2.png",
]
          ...
          <TabPanel value={value} index={1} dir={theme.direction}>
            <div className="container mx-auto flex justify-center items-center overflow-hidden">
              <div className="grid grid-cols-1 md:grid-cols-3 md:gap-5 gap-4">
                {certificateImages.slice(0, showAllCertificates ? certificateImages.length : initialItems).map((img, index) => (
                  <div
                    key={index}
                    data-aos={index % 3 === 0 ? "fade-up-right" : index % 3 === 1 ? "fade-up" : "fade-up-left"}
                    data-aos-duration={index % 3 === 0 ? "1000" : index % 3 === 1 ? "1200" : "1000"}
            ...
            {certificateImages.length > initialItems && (
              <div className="mt-6 w-full flex justify-start">
                <ToggleButton
            ...
            <div className="container mx-auto flex justify-center items-center overflow-hidden pb-[5%]">
              <div className="w-full">
                ...
                <p className="text-gray-400 text-sm text-center mb-8 max-w-2xl mx-auto">
                  These are the technologies I've worked with throughout my development journey.
